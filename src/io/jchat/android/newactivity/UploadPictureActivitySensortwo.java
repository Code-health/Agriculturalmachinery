...
public class UploadPictureActivitySensortwo extends Activity implements OnClickListener {
...
String card="";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sensortwo);
		...
		mCameraFilePath=card+"2.jpg";
		PushAgent.getInstance(UploadPictureActivitySensortwo.this).onAppStart();
		setUI();
		initView();
	}

	public void initView() {
		Updatefarmcoop.setActivitySensortwo(UploadPictureActivitySensortwo.this);
	...
	public void onClick(View v) {
		...
		case R.id.last:
			...
			break;
		case R.id.cameres:
			// selfcamere.startCamearPicCut(UploadPictureActivitySensortwo.this);
			break;
		case R.id.next:
			Intent in = new Intent();
			in.putExtra("carid", card);
			in.setClass(UploadPictureActivitySensortwo.this, UploadPictureActivitySensorthree.class);
			startActivity(in);
			break;
		default:
			break;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 1:
			...
			if (mImageCaptureUri != null) {
				...
				try {
					photoBmp = selfcamere.getBitmapFormUri(UploadPictureActivitySensortwo.this, mImageCaptureUri);
					...
					try {
						result = Uri.parse(
								MediaStore.Images.Media.insertImage(getContentResolver(), selfcamere.getBitmapFormUri(
										UploadPictureActivitySensortwo.this, Uri.fromFile(cameraFile)), "", ""));
						Bitmap photoBmp1 = selfcamere.getBitmapFormUri(UploadPictureActivitySensortwo.this,
						...
						// photoBmp1, "", ""));
						// 扫描相册
						UploadPictureActivitySensortwo.this
