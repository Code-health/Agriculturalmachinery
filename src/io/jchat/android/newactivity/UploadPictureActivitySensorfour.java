...
public class UploadPictureActivitySensorfour extends Activity implements OnClickListener {

	private ImageView bank, camces;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sensorfour);
		bank = (ImageView) findViewById(R.id.bank);
		camces = (ImageView) findViewById(R.id.cameres);
		last = (Button) findViewById(R.id.last);
		next = (Button) findViewById(R.id.next);
		myProgressBar = (ProgressBar) findViewById(R.id.myProgressBar);
		wb = (WebView) findViewById(R.id.web);
		mCameraFilePath = getIntent().getStringExtra("carid") + "4.jpg";
		PushAgent.getInstance(UploadPictureActivitySensorfour.this).onAppStart();
		initView();
	}
	...
	public void initView() {
		...
		camces.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.last:
			...
			break;
		case R.id.cameres:
			// selfcamere.startCamearPicCut(UploadPictureActivitySensorfour.this);
			break;
		case R.id.next:
			// Intent in=new Intent();
			// in.setClass(UploadPictureActivitySensorfour.this,
			// UploadPictureActivitySensorthree.class);
			// startActivity(in);
			Updatefarmcoop.getAddFarmMachiney().finish();
			Updatefarmcoop.getActivityOne().finish();
			Updatefarmcoop.getActivitySensorOne().finish();
			Updatefarmcoop.getActivitySensortwo().finish();
			Updatefarmcoop.getActivitySensorthree().finish();
			finish();
			break;
		default:
			break;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 1:
			...
			if (mImageCaptureUri != null) {
				...
				try {
					photoBmp = selfcamere.getBitmapFormUri(UploadPictureActivitySensorfour.this, mImageCaptureUri);
		...
		case REQUEST_UPLOAD_FILE_CODE:
			...
			if (result == null) {
				...
				if (cameraFile.exists()) {
					...
					try {
						result = Uri.parse(
								MediaStore.Images.Media.insertImage(getContentResolver(), selfcamere.getBitmapFormUri(
										UploadPictureActivitySensorfour.this, Uri.fromFile(cameraFile)), "", ""));
						Bitmap photoBmp1 = selfcamere.getBitmapFormUri(UploadPictureActivitySensorfour.this,
								Uri.fromFile(cameraFile));// 图片压缩
						...
						// photoBmp1, "", ""));
						// 扫描相册
						UploadPictureActivitySensorfour.this
