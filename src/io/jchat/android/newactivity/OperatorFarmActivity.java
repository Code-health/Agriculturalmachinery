...
public class OperatorFarmActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_opertorfarm);
...
//					hgmj.setText(miji + "亩");
	...
	public void showDialog() {
		CustomDialog2.Builder builder = new CustomDialog2.Builder(OperatorFarmActivity.this);
