...
public class UploadPictureActivitySensorOne extends Activity implements OnClickListener {
...
String card="";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sensorone);
		...
		mCameraFilePath=card+"1.jpg";
		PushAgent.getInstance(UploadPictureActivitySensorOne.this).onAppStart();
		setUI();
		initView();
	}

	public void initView() {
		Updatefarmcoop.setActivitySensorOne(UploadPictureActivitySensorOne.this);
	...
	public void onClick(View v) {
		...
		case R.id.last:
			...
			break;
		case R.id.cameres:
			// selfcamere.startCamearPicCut(UploadPictureActivitySensorOne.this);
			break;
		case R.id.next:
			Intent in = new Intent();
			in.putExtra("carid", card);
			in.setClass(UploadPictureActivitySensorOne.this, UploadPictureActivitySensortwo.class);
			startActivity(in);
			break;
		default:
			break;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 1:
			...
			if (mImageCaptureUri != null) {
				...
				try {
					photoBmp = selfcamere.getBitmapFormUri(UploadPictureActivitySensorOne.this, mImageCaptureUri);
					...
					try {
						result = Uri.parse(
								MediaStore.Images.Media.insertImage(getContentResolver(), selfcamere.getBitmapFormUri(
										UploadPictureActivitySensorOne.this, Uri.fromFile(cameraFile)), "", ""));
						Bitmap photoBmp1 = selfcamere.getBitmapFormUri(UploadPictureActivitySensorOne.this,
						...
						// photoBmp1, "", ""));
						// 扫描相册
						UploadPictureActivitySensorOne.this
