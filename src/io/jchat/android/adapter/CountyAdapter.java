...
import io.jchat.android.adapter.TownshipAdapter.Myhead;
...
public class CountyAdapter extends BaseAdapter{
	...
	public CountyAdapter(Context context,List<Carinfohistortylist> list,String type) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			head=new Myhead();
			convertView = LayoutInflater.from(context).inflate(R.layout.adapter_countys, null);
