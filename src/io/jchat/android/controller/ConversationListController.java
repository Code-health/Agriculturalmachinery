...
import io.jchat.android.activity.ContactsActivity;
...
//    private ImageButton create_group_btn;
    ...
    public ConversationListController(ConversationListView listView, ConversationListFragment context,
        ...
        this.mWidth = width;
//        create_group_btn = (ImageButton)mContext.getActivity().findViewById(R.id.create_group_btn);
//        create_group_btn.setOnClickListener(this);
    ...
    public void onClick(View v) {
		...
		case R.id.contacts_btn:
			...
			intent1.setClass(mContext.getContext(), ContactsActivity.class);
			mContext.getContext().startActivity(intent1);
			break;
		}
    }
